...
export const Review = () => {
  ...
  return (
    <>
      {success && <SuccessPrompt onClose={toggleModal} />}

      <div style={{ pointerEvents: success ? 'none' : 'auto', opacity: success ? 0.07: 1 }}>
        ...
        <div className={style.Button_main}>
          ...
          <div className={style.btn_back} onClick={handleBack}>
            <p>Back</p>
          </div>
          <div className={style.btn} onClick={toggleModal}>
            <p>Launch</p>
          </div>
        </div>
      </div>
